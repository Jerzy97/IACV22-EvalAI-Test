...
def run():
    ...
    challenge_id = 1
    challenge_phase = 'ex1'  # Add the challenge phase codename to be tested
    annotation_file_path = "{}/annotations/ex1".format(
        current_working_directory
    )  # Add the test annotation file path
    user_submission_file_path = "{}/submissions/ex1.zip".format(
        current_working_directory
